...
use Carbon\Carbon;
  ...
  //       if ($diamonds != '') {
		...
		// 		$sitemap->add(secure_url($translation['url'] .'/gia-loose-diamonds/'. $diamond->id), $diamond->updated_at, '0.8', 'daily', [], null, $translations);
		// 		}
		// 	}
		// }
		...
		$sitemap->add(secure_url('/big-sitemap/diamonds'), Carbon::now(), '1.0', 'daily');
