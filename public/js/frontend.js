        ...
        [
          ...
          _vm.init
            ? _c(
                ...
                {
                  staticClass:
                    "absolute flex left-1/2 top-1/2 border border-white border-2 bg-black p-1 px-4 rounded-lg hover:bg-gray-700 opacity-50"
                },
                [
                  _c(
                    "svg",
                    {
                      staticClass: "w-6 fill-current text-white ",
                      attrs: {
                        viewBox: "0 0 30 30",
                        xmlns: "http://www.w3.org/2000/svg"
                      }
      ...
      [
        ...
        _vm.videoSelecting == "video"
          ? _c(
              ...
              {
                staticClass:
                  "flex border border-white border-2 bg-black p-1 px-4 rounded-lg hover:bg-gray-700",
                on: {
                  click: function($event) {
