      ...
      for (var i = 0; this.shoppingCart.items.length > i; i++) {
        ...
        if (counteditem[i].pairItems.length > 0 && i != this.shoppingCart.selectingIndex) {
          ...
          if (item.length > 0) {
            ...
            message.next = {
              nextUrl: (0,_helpers_locale__WEBPACK_IMPORTED_MODULE_1__.getLocale)() + '/gia-loose-diamonds/',
...
/* harmony import */ var _shoppingCart_stripeCheckoutForm_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shoppingCart/stripeCheckoutForm.vue */ "./resources/js/components/shoppingCart/stripeCheckoutForm.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_data$watch$filters$c = {
  data: function data() {
    return {
      mutualVar: mutualVar,
      langs: langs,
  ...
  computed: {
    ...
    locale: function locale() {
      return (0,_helpers_locale__WEBPACK_IMPORTED_MODULE_1__.getLocale)();
    },
  ...
  assignCartItems: function assignCartItems() {
    ...
    var typeOptions = {
      'App/Diamond': {
        'type': 'diamonds',
        'url': (0,_helpers_locale__WEBPACK_IMPORTED_MODULE_1__.getLocale)() + '/gia-loose-diamonds/'
      },
      'App/EngagementRing': {
        'type': 'engagementRings',
        'url': (0,_helpers_locale__WEBPACK_IMPORTED_MODULE_1__.getLocale)() + '/engagement-rings/'
      },
      'App/Jewellery': {
        'type': 'mountingFee',
        'url': (0,_helpers_locale__WEBPACK_IMPORTED_MODULE_1__.getLocale)() + '/buying-procedure/diamond-inlay-engrave'
  ...
  directTo: function directTo(item) {
    ...
    if (Number.isInteger(item)) {
      ...
      urlId = (0,_helpers_locale__WEBPACK_IMPORTED_MODULE_1__.getLocale)() + urlId;
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      get("/api/engagementRings/".concat(window.location.pathname.slice(21))).then(function (res) {
        _this.engagementRing = res.data.model;

        _this.filterNotPostable(res.data.posts.invoicePosts);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      get("/api/jewellery/".concat(window.location.pathname.slice(14))).then(function (res) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    locale: function locale() {
      return (0,_helpers_locale__WEBPACK_IMPORTED_MODULE_2__.getLocale)();
    },
  ...
  methods: {
    fetchCookies: function fetchCookies() {
      ...
      if ((0,_helpers_cookie__WEBPACK_IMPORTED_MODULE_3__.getCookie)('coupon_code')) {
        this.cookies.coupon_code = (0,_helpers_cookie__WEBPACK_IMPORTED_MODULE_3__.getCookie)('coupon_code');
      }

      if ((0,_helpers_cookie__WEBPACK_IMPORTED_MODULE_3__.getCookie)('checkout')) {
        this.cookies.checkout = JSON.parse((0,_helpers_cookie__WEBPACK_IMPORTED_MODULE_3__.getCookie)('checkout'));
      }
    },
    sendCookies: function sendCookies() {
      ...
      (0,_helpers_cookie__WEBPACK_IMPORTED_MODULE_3__.setCookie)('coupon_code', this.cookies.coupon_code, this.cookies.cookieLast);
      (0,_helpers_cookie__WEBPACK_IMPORTED_MODULE_3__.setCookie)('checkout', JSON.stringify(this.cookies.checkout), this.cookies.cookieLast);
    },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      get("/api/weddingRings/".concat(window.location.pathname.slice(18))).then(function (res) {
        _this.weddingRing = res.data.model;
        _this.customerItems = res.data.posts;

        _this.UpperWeddingRings();

        _this.LowerWeddingRings();
      });
    },
    ...
    LowerWeddingRings: function LowerWeddingRings() {
      var obj = [];
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _videoPlayer_vue_vue_type_template_id_27614f7e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./videoPlayer.vue?vue&type=template&id=27614f7e& */ "./resources/js/components/videoPlayer.vue?vue&type=template&id=27614f7e&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _videoPlayer_vue_vue_type_template_id_27614f7e___WEBPACK_IMPORTED_MODULE_0__.render,
  _videoPlayer_vue_vue_type_template_id_27614f7e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/***/ "./resources/js/components/videoPlayer.vue?vue&type=template&id=27614f7e&":
/*!********************************************************************************!*\
  !*** ./resources/js/components/videoPlayer.vue?vue&type=template&id=27614f7e& ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_videoPlayer_vue_vue_type_template_id_27614f7e___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_videoPlayer_vue_vue_type_template_id_27614f7e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_videoPlayer_vue_vue_type_template_id_27614f7e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./videoPlayer.vue?vue&type=template&id=27614f7e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/videoPlayer.vue?vue&type=template&id=27614f7e&");
            ...
            ? _c(
                ...
                [
                  img.type == "img" || img.type == "video"
                    ? _c("img", {
                        staticClass: "rounded mx-auto p-2",
                        class: {
                          "border border-primary rounded":
                            _vm.currentUpperIndex == index
                        },
                        attrs: { src: _vm.images + img.thumb, width: "100%" }
                      })
                    : _vm._e(),
                  _vm._v(" "),
                  img.type == "video360"
          ...
          _c(
            ...
            [
              ...
              _vm.chunkedItems.length && !_vm.showUpper
                ? _c("p", { staticClass: "text-primary text-center p-4" }, [
              ...
              _vm._v(" "),
              _c("p", { staticClass: "text-lg font-light" }, [
        ...
        _vm._l(_vm.chunkedItems, function(img, index) {
          return img.thumb
            ? _c(
                ...
                [
                  _c("img", {
                    staticClass: "rounded mx-auto d-block image-background p-2",
                    class: {
                      " border border-primary rounded":
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/videoPlayer.vue?vue&type=template&id=27614f7e&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/videoPlayer.vue?vue&type=template&id=27614f7e& ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    ? _c(
        "div",
        {
          attrs: {
            ...
            autoplay: _vm.autoplay ? _vm.autoplay : false
          }
        },
        [
          _c(
            "video",
            {
              staticClass: "w-full h-auto video-js vjs-big-play-centered ",
              attrs: {
                id: "my-video",
                controls: "",
                autoplay: _vm.autoplay ? _vm.autoplay : false,
