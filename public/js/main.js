...
/* harmony import */ var _draggableItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./draggableItem */ "./resources/js/helpers/draggableItem.js");


window.getMeta = _getMeta__WEBPACK_IMPORTED_MODULE_1__.getMeta;

window.draggableItem = _draggableItem__WEBPACK_IMPORTED_MODULE_2__.draggableItem;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  cookiesInfo: {
    cookieLast: 60,
    diamondSearch: '',
...
/* harmony import */ var _langs_transJs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./langs/transJs */ "./resources/js/langs/transJs.js");
/* harmony import */ var _helpers_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/api */ "./resources/js/helpers/api.js");
/* harmony import */ var _components_shoppingCart_progress_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/shoppingCart/progress.vue */ "./resources/js/components/shoppingCart/progress.vue");
/* harmony import */ var _components_shoppingCart_icon_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/shoppingCart/icon.vue */ "./resources/js/components/shoppingCart/icon.vue");
/**
...
window.Vue = vue__WEBPACK_IMPORTED_MODULE_0__.default; //home


window.mutualVar = _helpers_mutualVar__WEBPACK_IMPORTED_MODULE_1__.default; // Langs


vue__WEBPACK_IMPORTED_MODULE_0__.default.filter('transJs', _langs_transJs__WEBPACK_IMPORTED_MODULE_2__.default.transJs);

window.get = _helpers_api__WEBPACK_IMPORTED_MODULE_3__.get;
window.post = _helpers_api__WEBPACK_IMPORTED_MODULE_3__.post;
...
var header = new vue__WEBPACK_IMPORTED_MODULE_0__.default({
  ...
  data: function data() {
    return {
      mutualVar: _helpers_mutualVar__WEBPACK_IMPORTED_MODULE_1__.default,
      burgerOpen: false,
      headerSection: 0
    };
  },
  ...
  created: function created() {
    _helpers_mutualVar__WEBPACK_IMPORTED_MODULE_1__.default.css.innerWidth = window.innerWidth;
  },
  destroyed: function destroyed() {},
  components: {
    ShoppingCartProgress: _components_shoppingCart_progress_vue__WEBPACK_IMPORTED_MODULE_4__.default,
    ShoppingCartIcon: _components_shoppingCart_icon_vue__WEBPACK_IMPORTED_MODULE_5__.default
  },
  computed: {
    shoppingCartNumber: function shoppingCartNumber() {
      return _helpers_mutualVar__WEBPACK_IMPORTED_MODULE_1__.default.cookiesInfo.shoppingCart.items.filter(function (data) {
        return data.addedCart == 1;
      }).length;
    }
  }
});
var footer = new vue__WEBPACK_IMPORTED_MODULE_0__.default({
  el: '#footer',
  data: function data() {
    return {
      footerSection: 1,
