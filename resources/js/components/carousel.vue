<template>
 ...
 -->
   ...
   <!--      <div class="box">
                    ...
                    <a v-for="(img, index) in upperitems.images" v-if="!upperitems.images">
                        <a class="btn" @click="currentSelectedItem(index,'upper')" :class="{ ' btn primary' : currentIndex == index }">{{ index+1 }}</a>
                    </a>
                    </div>

                <div class="level-item" @click="$emit('active', null)">
                    <a v-for="(img, index) in chunkedUpperItems" >
                        <a class="btn" @click="currentSelectedItem(index,'upper')" :class="{ ' btn primary' : currentIndex == index }">{{ index+1 }}</a>
                    </a>
                    </div>
                    ...
                    <div class="is-hidden-mobile">
                        ...
                        <nav class="pagination is-centered" role="navigation" aria-label="pagination">
                          <ul class="pagination-list">
                            <li @click="currentSelectedItem(currentIndex -5,'lower')"><a class="pagination-link" aria-label="Goto page 1">{{currentIndex < 5?0: currentIndex-5}}</a></li>
                            <li><span class="pagination-ellipsis">&hellip;</span></li>
                            <li @click="currentSelectedItem(currentIndex -1,'lower')"><a class="pagination-link" aria-label="Goto page 45">{{currentIndex}}</a></li>
                            <li  @click="currentSelectedItem(currentIndex,'lower')"><a class="pagination-link is-current" aria-label="Page 46" aria-current="page">{{currentIndex +1}}</a></li>
                            <li @click="currentSelectedItem(currentIndex +1,'lower')"><a class="pagination-link" aria-label="Goto page 47">{{currentIndex +2}}</a></li>
                            <li><span class="pagination-ellipsis">&hellip;</span></li>
                            <li @click="currentSelectedItem(currentIndex + items.length -1,'lower')"><a class="pagination-link" aria-label="Goto page 86">{{items.length}}</a></li>
                          </ul>
                        </nav>
