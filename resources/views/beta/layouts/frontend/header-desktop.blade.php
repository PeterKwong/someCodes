<div class="hidden lg:flex lg:flex-col">
    ...
    <div class="relative order-1 lg:order-2">
        <div class="max-w-screen-2xl 2xl:mx-auto mx-5 md:mx-10 lg:mx-20 flex items-center px-5">
            ...
            <ul class="hidden lg:flex flex-col w-52 space-y-3 lg:space-y-0 lg:w-auto lg:flex-row lg:items-center lg:space-x-10 diamond-details navbar font-suranna">
                <li class="dropdown-item">
                    <a href="{{ $baseUrl }}/gia-loose-diamonds">
                            ...
                            <div class="flex w-full border-t border-b border-05 py-5 max-w-screen-2xl 2xl:mx-auto px-5 md:px-10 lg:px-20 xl:px-28 font-lato">
                                <div class="flex lg:grid lg:grid-cols-2 gap-5  flex-wrap w-3/5 lg:px-16">
                                    <div class="flex flex-col space-y-2">
                                        <p class="font-lato font-bold text-brown">{{trans('header.Design Your Engagement Rings')}}</p>
                                        <a href="{{ $baseUrl }}/gia-loose-diamonds" class="dd-link group flex space-x-2 items-center max-w-max">
                                        ...
                                        <a href="{{ $baseUrl }}/engagement-rings" class="dd-link group flex space-x-2 items-center max-w-max">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="flex flex-col space-y-2">
                                        <p class="font-lato font-bold text-brown">
                                            <a href="{{ $baseUrl }}/gia-loose-diamonds/fancy-color" class="dd-link font-lato font-bold text-brown">{{trans('header.Fancy Color Diamond')}}</a>
                                        </p>
                                    ...
                                    <div class="flex flex-col space-y-2">
                                        <p class="font-lato font-bold text-brown">
                                            <a href="{{ $baseUrl }}/gia-loose-diamonds" class="dd-link font-lato font-bold text-brown">{{trans('header.Loose Diamond')}}</a>
                                        </p>
                                        <a href="{{ $baseUrl }}/gia-loose-diamonds/round-cut" class="dd-link group flex space-x-2 items-center max-w-max">
                                            ...
                                            <span class="font-lato">{{trans('header.Round')}}</span>
                                        </a>
                                    </div>
                                    <div class="flex flex-col space-y-2">
                                        <p class="font-lato font-bold text-brown">
                                            <a href="{{ $baseUrl }}/gia-loose-diamonds/fancy-cut-diamond" class="dd-link font-lato font-bold text-brown">{{trans('header.Fancy Cut Diamond')}}</a>
                                        </p>
                ...
                <li class="dropdown-item">
                    <a href="{{ $baseUrl }}/engagement-rings">
                                ...
                                <div class="flex space-x-10">
                                    <div class="flex flex-col space-y-2">
                                        ...
                                        <a href="{{ $baseUrl }}/gia-loose-diamonds" class="dd-link group flex space-x-2 items-center max-w-max">
                                            ...
                                            <span class="font-lato">{{trans('header.Start with a Diamond')}}</span>
                                        </a>
                                    </div>
                                    <div class="flex flex-col space-y-2">
                                        <p class="font-lato font-bold text-brown">{{trans('header.Engagement Rings Style')}}</p>
                                        <div class="flex space-x-7">
                                            <div class="flex flex-col space-y-2">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="flex justify-between w-full border-t border-b border-05 py-5 max-w-screen-2xl 2xl:mx-auto px-5 md:px-10 lg:px-20 xl:px-28 font-lato">
                            ...
                            <div class="flex items-center space-x-7">
                                <img src="/assets/images/wr-dd-1.jpg" alt="">
                                <img src="/assets/images/wr-dd-2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </li>
                <li class="dropdown-item">
                    <a href="{{ $baseUrl }}/jewellery">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="flex justify-between w-full border-t border-b border-05 py-5 max-w-screen-2xl 2xl:mx-auto px-5 md:px-10 lg:px-20 xl:px-28 font-lato">
                            <div class="flex space-x-14">
                                <div class="flex flex-col space-y-2">
                                    <a href="{{ $baseUrl }}/jewellery/rings" class="dd-link group flex space-x-2 items-center max-w-max">
                                        ...
                                        <span class="font-lato font-bold text-brown">{{trans('header.Rings')}}</span>
                                    </a>
                                    <a href="{{ $baseUrl }}/jewellery/diamond-rings" class="pl-6 dd-link font-lato flex space-x-2 items-center max-w-max">                                                                 
                                        {{trans('header.Diamond Rings')}}
                                    </a>
                                    <a href="{{ $baseUrl }}/jewellery/fancy-diamond-rings" class="pl-6 dd-link font-lato flex space-x-2 items-center max-w-max">                                                                 
                            ...
                            <div class="flex">
                                <img src="/assets/images/j-dd.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </li>
                <li class="dropdown-item">
                    <a href="{{ $baseUrl }}/education-diamond-grading">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="flex justify-between w-full border-t border-b border-05 py-5 max-w-screen-2xl 2xl:mx-auto px-5 md:px-10 lg:px-20 xl:px-28 font-lato">
                            <div class="flex space-x-14">
                                <div class="flex flex-col space-y-2">
                                    <p class="font-lato font-bold text-brown">
                                        <a href="{{ $baseUrl }}/education-diamond-grading/4cs" class="dd-link font-lato font-bold text-brown">{{trans('header.Diamond Grading | 4Cs')}}</a>
                                    </p>
                                ...
                                <div class="flex flex-col space-y-2">
                                    <p class="font-lato font-bold text-brown">
                                        <a href="{{ $baseUrl }}/education-diamond-grading/gia-report" class="dd-link font-lato font-bold text-brown">{{trans('header.Diamond Certificates')}}</a>
                                    </p>
                                ...
                                <div class="flex flex-col space-y-2">
                                    <p class="font-lato font-bold text-brown">
                                        <a href="{{ $baseUrl }}/education-diamond-grading/gia-report" class="dd-link font-lato font-bold text-brown">{{trans('header.Diamond Anatomy')}}</a>
                                    </p>
                            ...
                            <div class="flex">
                                <img src="/assets/images/edu-dd.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </li>
                <li class="dropdown-item">
                    <a href="{{ $baseUrl }}/customer-jewellery">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="flex justify-between w-full border-t border-b border-05 py-5 max-w-screen-2xl 2xl:mx-auto px-5 md:px-10 lg:px-20 xl:px-28 font-lato">
                            ...
                            <div class="flex items-center space-x-7">
                                <img src="/assets/images/cj-dd-1.jpg" alt="">
                                <img src="/assets/images/cj-dd-2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </li>
                <li class="dropdown-item">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="flex justify-between w-full border-t border-b border-05 py-5 max-w-screen-2xl 2xl:mx-auto px-5 md:px-10 lg:px-20 xl:px-28 font-lato">
                            ...
                            <div class="flex items-center space-x-7">
                                <img src="/assets/images/about-dd-1.jpg" alt="">
                                <img src="/assets/images/about-dd-2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </li>
