	 ...
	 -->								<input class="form-control" type="text" name="stock" v-model="form.invoice_diamonds[index].stock">
			...
			<div class="card" >
				...
				<div class="card-body" v-for="(jewellery,index) in form.jewelleries">
					...
					<div v-if="jewellery.invoice_items">
						<div class="row" v-for="item in jewellery.invoice_items" v-if="jewellery.invoice_items.length">
							<div class="col-1">
							</div>
			...
			<div class="card" >
				...
				<div class="card-body" v-for="(engagementRing,index) in form.engagement_rings">
					...
					<div  v-if="engagementRing.invoice_items">
						<div class="row" v-for="item in engagementRing.invoice_items" v-if="engagementRing.invoice_items.length">
							<div class="col-1">
							</div>
			...
			<h3>weddingRing</h3>
				<div class="card-body" v-for="(weddingRing,index) in form.wedding_rings">
					...
					<div v-if="weddingRing.invoice_items">
						<div class="row" v-for="item in weddingRing.invoice_items" v-if="weddingRing.invoice_items.length">
							<div class="col-1">
							</div>
