@extends('backEnd.app')
	...
	@section('content')
      ...
      @endif
            ...
            <data-viewer :source = "dataViewer.source" :thead="dataViewer.thead" :filter="dataViewer.filter" :create="dataViewer.create" :title="dataViewer.title" :column="column" :per_page="dataViewer.per_page">
