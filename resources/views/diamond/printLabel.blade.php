	...
	<div class="flex-container">
		<div >
			<div class="flex-container">
				...
				<div style="width: 90px;  font-size: 20px">$123141</div>
			</div>
			<div class="flex-container">
				<div style="width: 120px; font-size: 15px">S138-ekjr123-123</div>
			</div>
			<div class="flex-container">
				<div style="width: 120px; font-size: 15px">1.01 , G , VVS2 </div>
			</div>
		</div>
		<div>
			<div id="qrcode"></div>
