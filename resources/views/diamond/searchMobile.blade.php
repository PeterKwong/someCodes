<!-- <div class="flex items-center justify-between border border-gray-600 p-2 mx-1 text-center" @click="selectDisplayColumn('shape')">
  <div class="flex-auto" >
    {{trans('diamondSearch.Shape')}}      <i class="fas fa-chevron-down"></i>
    <div class="flex justify-center"  >
        <a @click="selectDisplayColumn('shape')">
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[0].clicked" type="button" @click="toggleValue(query.search_conditions.shape[0].clicked,'shape', 0)">
                <img src="/images/front-end/diamond_shapes/Round.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[1].clicked" type="button" @click="toggleValue(query.search_conditions.shape[1].clicked,'shape', 1)">
                <img src="/images/front-end/diamond_shapes/Pear.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[2].clicked" type="button" @click="toggleValue(query.search_conditions.shape[2].clicked,'shape', 2)">
                <img src="/images/front-end/diamond_shapes/Emerald.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[3].clicked" type="button" @click="toggleValue(query.search_conditions.shape[3].clicked,'shape', 3)">
                <img src="/images/front-end/diamond_shapes/Princess.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[4].clicked" type="button" @click="toggleValue(query.search_conditions.shape[4].clicked,'shape', 4)">
                <img src="/images/front-end/diamond_shapes/Marquise.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[5].clicked" type="button" @click="toggleValue(query.search_conditions.shape[5].clicked,'shape', 5)">
                <img src="/images/front-end/diamond_shapes/Cushion.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[6].clicked" type="button" @click="toggleValue(query.search_conditions.shape[6].clicked,'shape', 6)">
                <img src="/images/front-end/diamond_shapes/Asscher.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[7].clicked" type="button" @click="toggleValue(query.search_conditions.shape[7].clicked,'shape', 7)">
                <img src="/images/front-end/diamond_shapes/Oval.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[8].clicked" type="button" @click="toggleValue(query.search_conditions.shape[8].clicked,'shape', 8)">
                <img src="/images/front-end/diamond_shapes/Heart.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" v-if=" query.search_conditions.shape[9].clicked" type="button" @click="toggleValue(query.search_conditions.shape[9].clicked,'shape', 9)">
                <img src="/images/front-end/diamond_shapes/Radiant.png" class="w-8">
        </button>
      </a>
    </div>
    <div class="flex justify-between" v-if="displayColumn == 'shape' "  @click="selectDisplayColumn('shape')">
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[0].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[0].clicked,'shape', 0)">
          <img src="/images/front-end/diamond_shapes/Round.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[1].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[1].clicked,'shape', 1)">
          <img src="/images/front-end/diamond_shapes/Pear.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[2].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[2].clicked,'shape', 2)">
          <img src="/images/front-end/diamond_shapes/Emerald.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[3].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[3].clicked,'shape', 3)">
          <img src="/images/front-end/diamond_shapes/Princess.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[4].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[4].clicked,'shape', 4)">
          <img src="/images/front-end/diamond_shapes/Marquise.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[5].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[5].clicked,'shape', 5)">
          <img src="/images/front-end/diamond_shapes/Cushion.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[6].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[6].clicked,'shape', 6)">
          <img src="/images/front-end/diamond_shapes/Asscher.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[7].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[7].clicked,'shape', 7)">
          <img src="/images/front-end/diamond_shapes/Oval.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[8].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[8].clicked,'shape', 8)">
          <img src="/images/front-end/diamond_shapes/Heart.png" class="w-8">
        </button>
        <button  class="btn btn-outline p-1" :class=" {' active' : query.search_conditions.shape[9].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[9].clicked,'shape', 9)">
          <img src="/images/front-end/diamond_shapes/Radiant.png" class="w-8">
        </button>
    </div>
  </div>
...
<div class="flex border border-gray-600 p-2 mx-1 text-center" >
  <div class="flex-auto" >
    <div class="flex items-center justify-center " @click="selectDisplayColumn('price')">
      {{trans('diamondSearch.Price')}}  
      <button class="btn btn-outline"> $ @{{fetchData.priceRange[0]}} - $ @{{fetchData.priceRange[1]}} </button>     
      <i class="fas fa-chevron-down"></i>
    </div>

    <div class="flex justify-center"  >
          <div class="flex"  v-if="displayColumn == 'price' ">
...
<div class="flex border border-gray-600 p-2 mx-1 text-center" >
  <div class="flex-auto" >
    <div class="flex items-center justify-center " @click="selectDisplayColumn('weight')">
      {{trans('diamondSearch.Weight')}}  
      <button class="btn btn-outline"> @{{fetchData.weight[0]}} - @{{fetchData.weight[1]}} </button>     
      <i class="fas fa-chevron-down"></i>
    </div>

    <div class="flex justify-center"  >
          <div class="flex"  v-if="displayColumn == 'weight' ">
        ...
        <div class="border border-gray-300 p-2 mx-1">
           <div  class="hover:text-blue-600" @click="selectDisplayColumn('shape')">
              ...
              <a  class="hover:text-blue-600" @click="selectDisplayColumn('shape')">
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[0].clicked" type="button" @click="toggleValue(query.search_conditions.shape[0].clicked,'shape', 0)">
                          <img src="/images/front-end/diamond_shapes/Round.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[1].clicked" type="button" @click="toggleValue(query.search_conditions.shape[1].clicked,'shape', 1)">
                          <img src="/images/front-end/diamond_shapes/Pear.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[2].clicked" type="button" @click="toggleValue(query.search_conditions.shape[2].clicked,'shape', 2)">
                          <img src="/images/front-end/diamond_shapes/Emerald.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[3].clicked" type="button" @click="toggleValue(query.search_conditions.shape[3].clicked,'shape', 3)">
                          <img src="/images/front-end/diamond_shapes/Princess.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[4].clicked" type="button" @click="toggleValue(query.search_conditions.shape[4].clicked,'shape', 4)">
                          <img src="/images/front-end/diamond_shapes/Marquise.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[5].clicked" type="button" @click="toggleValue(query.search_conditions.shape[5].clicked,'shape', 5)">
                          <img src="/images/front-end/diamond_shapes/Cushion.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[6].clicked" type="button" @click="toggleValue(query.search_conditions.shape[6].clicked,'shape', 6)">
                          <img src="/images/front-end/diamond_shapes/Cushion.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[7].clicked" type="button" @click="toggleValue(query.search_conditions.shape[7].clicked,'shape', 7)">
                          <img src="/images/front-end/diamond_shapes/Cushion.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[8].clicked" type="button" @click="toggleValue(query.search_conditions.shape[8].clicked,'shape', 8)">
                          <img src="/images/front-end/diamond_shapes/Cushion.png" height="20" width="20">
                  </button>
                  <button  class="btn btn-outline" v-if=" query.search_conditions.shape[9].clicked" type="button" @click="toggleValue(query.search_conditions.shape[9].clicked,'shape', 9)">
                          <img src="/images/front-end/diamond_shapes/Cushion.png" height="20" width="20">
                  </button>
              </a>
              <i class="fas fa-chevron-down"></i>
          ...
          <div v-if="displayColumn == 'shape' ">
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[0].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[0].clicked,'shape', 0)">
                <img src="/images/front-end/diamond_shapes/Round.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[1].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[1].clicked,'shape', 1)">
                <img src="/images/front-end/diamond_shapes/Pear.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[2].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[2].clicked,'shape', 2)">
                <img src="/images/front-end/diamond_shapes/Emerald.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[3].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[3].clicked,'shape', 3)">
                <img src="/images/front-end/diamond_shapes/Princess.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[4].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[4].clicked,'shape', 4)">
                <img src="/images/front-end/diamond_shapes/Marquise.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[5].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[5].clicked,'shape', 5)">
                <img src="/images/front-end/diamond_shapes/Cushion.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[6].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[6].clicked,'shape', 6)">
                <img src="/images/front-end/diamond_shapes/Asscher.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[7].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[7].clicked,'shape', 7)">
                <img src="/images/front-end/diamond_shapes/Oval.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[8].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[8].clicked,'shape', 8)">
                <img src="/images/front-end/diamond_shapes/Heart.png" height="20" width="20">
              </button>
              <button  class="btn btn-outline" :class=" {' active' : query.search_conditions.shape[9].clicked} " type="button" @click="toggleValue(query.search_conditions.shape[9].clicked,'shape', 9)">
