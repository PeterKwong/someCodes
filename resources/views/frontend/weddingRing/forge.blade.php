@extends('layouts.section.frontend')
    ...
    @section('meta')
        ...
        <title>{{trans('weddingRing.metaTitle1')}} - {{trans('home.webTitle')}}</title>
        <meta name="description" content="{{trans('weddingRing.metaDescription1')}} - {{trans('home.meta2')}}" />

        <!-- Schema.org markup for Google+ --> 
        <meta itemprop="name" content="{{trans('weddingRing.metaTitle1')}} - {{trans('home.webTitle')}}"> 
        ...
        <!-- Open Graph data --> 
        <meta property="og:title" content="{{trans('weddingRing.metaTitle1')}} - {{trans('home.webTitle')}}" /> 
        <meta property="og:url" content="{{url("/")}}" />
        <meta property="og:image" content="{{url("/front_end/home/h1_300-1.png")}}" />
        <meta property="og:description" content="{{trans('weddingRing.metaDescription1')}} - {{trans('home.meta2')}}" /> 
        <meta property="og:site_name" content="{{trans('weddingRing.metaTitle1')}} - {{trans('home.webTitle')}}" /> 
    ...
    @section('content')
        <br>
            <div class="row" >
                <div class="col-12">
                    <center><h1 class="title is-5">{{trans('weddingRing.metaTitle1')}}</h1>                        
                    </center>
