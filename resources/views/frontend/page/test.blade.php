...
<body>
        ...
        <div class="hidden lg:flex lg:flex-col">
            <div class="order-2 lg:order-1 flex flex-col lg:flex-row lg:items-center justify-between pb-10">
                ...
                <nav class="flex items-center space-x-5">
                    ...
                    <ul class="hidden lg:flex items-center divide-x divide-opacity-20 space-x-3">
                        <li>
            ...
            <div class="order-1 lg:order-2 flex items-center px-5">
                ...
                <ul class="hidden lg:flex flex-col w-52 space-y-3 lg:space-y-0 lg:w-auto lg:flex-row lg:items-center lg:space-x-10 navbar">
                    <li>
                        <a href="#">
                            <span>鑽石</span>
                        </a>
        ...
        <div x-data="{ sidebarOpen : false, cartOpen : false}" class="flex flex-col lg:hidden">
            <div class="flex justify-between items-center lg:hidden">
                ...
                <a  class="w-11 h-12" href="#">
                    <img src="{{url('assets/images/Logo-mobile')}}.png" alt="">
                </a>
            ...
            <div x-show="sidebarOpen" class="sidebar">
                <div @click.away="sidebarOpen = false" class="fixed inset-0 w-3/4 p-3 bg-white z-50 border-2 border-sgb-pink h-full overflow-y-scroll">
                    ...
                    <ul class="relative z-50 flex flex-col space-y-5 uppercase">
                        <li>
                            <a href="#">
                                <span>鑽石</span>
                            </a>
                    ...
                    <ul class="flex items-center justify-center divide-x divide-opacity-20 space-x-3 mt-5">
                        <li>
                            <a class="pl-3 active" href="#">
                                <span>繁</span>
                            </a>
    ...
    <div class="relative flex flex-col max-w-screen-2xl 2xl:mx-auto md:mx-10 lg:mx-20 px-5 md:px-0">
                        ...
                        <fieldset class="flex items-center space-x-5">
                            <label class="relative block rounded border bg-white p-5 cursor-pointer hover:border-ting-blue sm:flex sm:justify-between bg-ting-blue-light border-ting-blue">
                                ...
                                <div class="flex flex-col items-center space-y-2">
                                    <img src="{{url('assets/images/ring-design')}}-1.png" alt="">
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <fieldset class="flex items-center space-x-5">
                            <label class="relative block rounded border bg-white p-5 cursor-pointer hover:border-ting-blue sm:flex sm:justify-between focus-within:bg-ting-blue-light focus-within:border-ting-blue">
                                ...
                                <div class="flex flex-col items-center space-y-2">
                                    <img src="{{url('assets/images/ring-design')}}-4.png" alt="">
                            ...
                            <label class="relative block rounded border bg-white p-5 cursor-pointer hover:border-ting-blue sm:flex sm:justify-between focus-within:bg-ting-blue-light focus-within:border-ting-blue">
                                ...
                                <div class="flex flex-col items-center space-y-2">
                                    <img src="{{url('assets/images/ring-design')}}-5.png" alt="">
                            ...
                            <label class="relative block rounded border bg-white p-5 cursor-pointer hover:border-ting-blue sm:flex sm:justify-between focus-within:bg-ting-blue-light focus-within:border-ting-blue">
                                ...
                                <div class="flex flex-col items-center space-y-2">
                                    <img src="{{url('assets/images/ring-design')}}-6.png" alt="">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 w-full xl:grid-cols-4 gap-3 md:gap-7 md:items-center py-10 2xl:py-20 2xl:pb-10">
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p1.png')}}" alt="Product 1">
                ...
                <div class="absolute top-3 md:top-7 left-3 md:left-7">
                    <div class="relative flex items-center justify-center">
                        <img class="w-5 md:w-auto h-7 md:h-auto" src="{{url('assets/images/badge-diamond')}}.png" alt="">
                        <span class="absolute top-1.5 md:top-3 h-full text-xs md:text-base text-white">新</span>
                    </div>
                </div>
            </div>
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p2.png')}}" alt="Product 2">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p3.png')}}" alt="Product 3">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
                        <span class="text-xl md:text-4xl">$3800</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p4.png')}}" alt="Product 4">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p5.png')}}" alt="Product 5">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p6.png')}}" alt="Product 6">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p7.png')}}" alt="Product 7">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
                        <span class="text-xl md:text-4xl">$6100</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p8.png')}}" alt="Product 8">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p9.png')}}" alt="Product 9">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p10.png')}}" alt="Product 10">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
                        <span class="text-xl md:text-4xl">$4800</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p11.png')}}" alt="Product 11">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
            ...
            <div class="flex flex-col relative product-card p-0 md:p-5 cursor-pointer transform hover:-translate-y-2 transition duration-500">
                <img class="mt-5 md:mt-0" src="{{url('assets/images/p12.png')}}" alt="Product 21">
                <div class="flex flex-col items-center space-y-2 md:space-y-3">
                    <p class="flex items-center space-x-1 font-suranna text-gold">
                        <span class="text-base md:text-xl">HKD</span>
                        <span class="text-xl md:text-4xl">$7200</span>
            ...
            <div class="flex flex-col space-y-5">
                ...
                <div class="flex flex-wrap items-center gap-4 md:gap-0 md:space-x-10">
                    <div class="flex space-x-4 md:space-x-5 items-center">
                        <img class="w-5 md:w-auto" src="{{url('assets/images/notes.svg')}}" alt="">
                        <span class="text-xs md:text-base">GIA證書</span>
                    </div>
                    <div class="flex space-x-4 md:space-x-5 items-center">
                        <img class="w-7 md:w-auto" src="{{url('assets/images/youtube.svg')}}" alt="">
                        <span class="text-xs md:text-base">360度高清影片</span>
                    </div>
                    <div class="flex space-x-4 md:space-x-5 items-center">
                        <img class="w-5 md:w-auto" src="{{url('assets/images/ring.svg')}}" alt="">
                        <span class="text-xs md:text-base">1000＋成品</span>
                    </div>
                    <div class="flex space-x-4 md:space-x-5 items-center">
                        <img class="w-7 md:w-auto" src="{{url('assets/images/crown.svg')}}" alt="">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 md:items-center gap-y-5 md:gap-y-0 gap-x-2 md:gap-x-10">
                    <div class="flex flex-col space-y-3">
                        <a href="#" class="inline-block overflow-hidden">
                            <img class="w-full h-full transform hover:scale-110 transition duration-500" src="{{url('assets/images/j1.png')}}" alt="Jewelry-1">
                        </a>
                        <span>鑽石4Cs智識</span>
                    </div>
                    <div class="flex flex-col space-y-3">
                        <a href="#" class="inline-block overflow-hidden">
                            <img class="w-full h-full transform hover:scale-110 transition duration-500" src="{{url('assets/images/j2.png')}}" alt="Jewelry-2">
                        </a>
                        <span>購買鑽石洗程</span>
                    </div>
                    <div class="flex flex-col space-y-3">
                        <a href="#" class="inline-block overflow-hidden">
                            <img class="w-full h-full transform hover:scale-110 transition duration-500" src="{{url('assets/images/j3.png')}}" alt="Jewelry-3">
                        </a>
                        <span>客人成品</span>
                    </div>
                    <div class="flex flex-col space-y-3">
                        <a href="#" class="inline-block overflow-hidden">
                            <img class="w-full h-full transform hover:scale-110 transition duration-500" src="{{url('assets/images/j4.png')}}" alt="Jewelry-4">
                        </a>
                        <span>關於我們</span>
                    </div>
                </div>
    ...
    <footer class="bg-grey-dark" aria-labelledby="footerHeading">
        <div class="max-w-screen-2xl 2xl:mx-auto md:mx-10 xl:mx-20 pt-12 lg:pt-16 pb-5 lg:pb-7 px-4 lg:px-8">
            <div class="grid lg:grid-cols-4 lg:gap-x-20 lg:divide-x divide-white divide-opacity-20">
                <div class="flex flex-col w-full space-y-10">
                    <div class="flex space-x-3 lg:space-x-7">
                        <a class="inline-block w-48" href="#">
                            <img src="{{url('assets/images/Logo-white')}}-mobile.png" alt="">
                        </a>
                        <div class="flex flex-col space-y-5 mt-1 lg:mt-0">
                            <p class="text-sm text-white">
                                TING DIAMOND 精選GIA裸鑽， 以批發價出售，務求做到物超所值
                            </p>
                    ...
                    <div class="hidden lg:flex w-full items-center space-x-5">
                        <div><img src="{{url('assets/images/GIA.png')}}" alt=""></div> 
                        <div><img src="{{url('assets/images/IE.png')}}" alt=""></div> 
                    </div>
                </div>
                <div class="flex flex-col space-y-3 lg:space-y-0 divide-y lg:divide-none divide-white divide-opacity-20 lg:flex-row lg:justify-between lg:col-span-3 lg:pl-10 xl:pl-20">
            ...
            <div class="flex items-end lg:items-center justify-between pt-10 lg:pt-7">
                ...
                <div class="flex justify-end lg:justify-start h-5 lg:h-auto space-x-1.5">
                    <img src="{{url('assets/images/eps.png')}}" alt="">
                    <img src="{{url('assets/images/mc.png')}}" alt="">
                    <img src="{{url('assets/images/visa.png')}}" alt="">
                    <img src="{{url('assets/images/ae.png')}}" alt="">
                    <img src="{{url('assets/images/up.png')}}" alt="">
                    <img src="{{url('assets/images/wechat.png')}}" alt="">
                </div>
            </div>
