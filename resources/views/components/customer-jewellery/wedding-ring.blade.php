...
<div class="grid grid-cols-6 divide-y md:divide-y-0 space-y-5 md:space-y-0 md:divide-x">
    <div class="col-span-5 md:col-span-3 flex flex-col space-y-3 ">
        ...
        <div class="grid grid-cols-5 space-x-3">
            ...
            <span class="col-span-3">
                <a class="text-brown" target="_blank" href="/{{app()->getLocale() . '/wedding-rings?shape=' . $weddingRings->weddingRings[0]->shape }}">
        ...
        <div class="grid grid-cols-5 space-x-3">
            ...
            <span class="col-span-3">
                 <a class="text-brown" target="_blank" href="/{{app()->getLocale() . '/wedding-rings?finish=' . $weddingRings->weddingRings[0]->finish }}">
        ...
        <div class="grid grid-cols-5 space-x-3">
            ...
            <span class="col-span-3">
                <a class="text-brown" target="_blank" href="/{{app()->getLocale() . '/wedding-rings?metal=' . $weddingRings->weddingRings[0]->metal }}">
    ...
    <div class="col-span-5 md:col-span-3 flex flex-col space-y-3 pt-5 md:pt-0 md:pl-16">
        ...
        <div class="grid grid-cols-5 space-x-3">
            ...
            <span class="col-span-3">
                <a class="text-brown" target="_blank" href="/{{app()->getLocale() . '/wedding-rings?shape=' . $weddingRings->weddingRings[1]->shape }}">
        ...
        <div class="grid grid-cols-5 space-x-3">
            ...
            <span class="col-span-3">
                <a class="text-brown" target="_blank" href="/{{app()->getLocale() . '/wedding-rings?finish=' . $weddingRings->weddingRings[1]->finish }}">
        ...
        <div class="grid grid-cols-5 space-x-3">
            ...
            <span class="col-span-3">
                <a class="text-brown" target="_blank" href="/{{app()->getLocale() . '/wedding-rings?metal=' . $weddingRings->weddingRings[1]->metal }}">
