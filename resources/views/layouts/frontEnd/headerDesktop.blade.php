  ...
  <div class="dropdown">
      ...
      <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
        ...
        <li class="border border-gray-300 text-left">
          <a class="text-blue-500 p-1" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond">{{trans('frontHeader.Fancy Cut Diamonds')}}
         </a>
          <span class="flex justify-between p-2 px-4">
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/heart-shaped"><img class="w-6 h-6" src="/images/front-end/diamond_shapes/HT.png" > {{trans('frontHeader.Heart')}}
            </a>
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/princess-cut"><img class="w-6 h-6" src="/images/front-end/diamond_shapes/PR.png" > {{trans('frontHeader.Princess')}}
            </a>
          </span>
          <span class="flex justify-between p-2 px-4">
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/emerald-cut"><img src="/images/front-end/diamond_shapes/EM.png" class="w-6 h-6"> {{trans('frontHeader.Emerald')}}
            </a>
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/asscher-cut"><img src="/images/front-end/diamond_shapes/AC.png" class="w-6 h-6"> {{trans('frontHeader.Asscher')}}
            </a>
          </span>

          <span class="flex justify-between p-2 px-4">
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/cushion-cut"><img src="/images/front-end/diamond_shapes/CU.png" class="w-6 h-6"> {{trans('frontHeader.Cushion')}}
            </a>
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/oval-cut"><img src="/images/front-end/diamond_shapes/OV.png" class="w-6 h-6"> {{trans('frontHeader.Oval')}}
            </a>                 
          </span>  

          <span class="flex justify-between p-2 px-4">
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/marquise-cut"><img src="/images/front-end/diamond_shapes/MQ.png" class="w-6 h-6"> {{trans('frontHeader.Marquise')}}
            </a>
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/radiant-cut"><img src="/images/front-end/diamond_shapes/RA.png" class="w-6 h-6"> {{trans('frontHeader.Radiant')}}
            </a>                 
          </span>  

          <span class="flex justify-between p-2 px-4">
            <a class="flex justify-start hover:text-blue-300" href="{{url(app()->getLocale())}}/gia-loose-diamonds/fancy-cut-diamond/pear-shaped"><img src="/images/front-end/diamond_shapes/PS.png" class="w-6 h-6"> {{trans('frontHeader.Pear')}}
            </a>                 
          </span>  
        </li>
        <li class="border border-gray-300 text-left">
