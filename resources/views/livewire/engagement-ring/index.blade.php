              ...
              <div class="flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:space-x-10 font-lato">
                  <div class="flex flex-col space-y-2">
                      ...
                      <fieldset class="flex items-center space-x-5">
                          <label class="relative block rounded border bg-white p-3 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown {{$search_conditions['style']['solitaire']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="style" value="3" class="sr-only">
                              <div class="flex flex-col items-center space-y-2" 
                              		wire:click="toggleValue('style','solitaire')">
                          ...
                          <label class="relative block rounded border bg-white p-3 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown
                          {{$search_conditions['style']['side-stone']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="style" value="3" class="sr-only">
                              <div class="flex flex-col items-center space-y-2"
                              wire:click="toggleValue('style','side-stone')">
                          ...
                          <label class="relative block rounded border bg-white p-3 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown
                          {{$search_conditions['style']['halo']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="style" value="3" class="sr-only">
                              <div class="flex flex-col items-center space-y-2"
                              wire:click="toggleValue('style','halo')">
                  ...
                  <div class="flex flex-col space-y-2">
                      ...
                      <fieldset class="flex items-center space-x-5">
                          <label class="relative block rounded border bg-white p-3 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown 
                          {{$search_conditions['shoulder']['tapering']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="position" value="1" class="sr-only">
                              <div class="flex flex-col items-center space-y-2"
                              wire:click="toggleValue('shoulder','tapering')">
                          ...
                          <label class="relative block rounded border bg-white p-3 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown 
                          {{$search_conditions['shoulder']['parallel']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="position" value="2" class="sr-only">
                              <div class="flex flex-col items-center space-y-2"
                              wire:click="toggleValue('shoulder','parallel')">
                          ...
                          <label class="relative block rounded border bg-white p-3 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown 
                          {{$search_conditions['shoulder']['twisted']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="position" value="3" class="sr-only">
                              <div class="flex flex-col items-center space-y-2"
                              wire:click="toggleValue('shoulder','twisted')">
                  ...
                  <div class="flex flex-col space-y-2">
                      ...
                      <fieldset class="flex flex-row space-x-3 md:space-x-0 md:flex-col h-full md:justify-between">
                          <label class="relative block rounded border bg-white px-5 py-2.5 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown
                          {{$search_conditions['prong']['4-prong']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="claws" value="1" class="sr-only"
                               wire:click="toggleValue('prong','4-prong')">
                                  <p id="server-size-1-label">{{__('engagementRing.4-prong')}}</p>
                          </label>
                          <label class="relative block rounded border bg-white px-5 py-2.5 cursor-pointer hover:border-brown sm:flex sm:justify-between hover:bg-brown-light focus-within:bg-brown-light focus-within:border-brown
                          {{$search_conditions['prong']['6-prong']['clicked']? 'border-brown bg-brown-light':'' }}">
                              <input type="checkbox" name="claws" value="2" class="sr-only"
                               wire:click="toggleValue('prong','6-prong')">
                  ...
                  <div class="flex flex-col space-y-2">
                      ...
                      <select id="other_styles" 
                      				name="other_styles" 
                      				class="custom-select block w-full md:w-36 pb-1 text-black text-opacity-50 border-b border-opacity-20 focus:outline-none"
                      				wire:model="fetchData.other.0">
                  ...
                  <a class="flex md:hidden items-center justify-center w-full py-2 bg-brown hover:bg-white text-white hover:text-brown border border-brown transition ease-in-out duration-500" @click="applyFilter = !applyFilter">
                        <span class="text-white hover:text-brown font-bold font-lato tracking-widest uppercase">{{__('weddingRing.Apply')}}
                        </span>
                  </a>
              </div>
          </form>
