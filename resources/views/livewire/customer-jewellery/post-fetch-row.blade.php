<div class="grid md:grid-cols-2 w-full gap-3 md:gap-7 md:items-center">
    ...
    @if(count($post->images))
        <div x-data="{details: false}" @mouseover="details = true" @mouseleave="details = false" class="bg-white grid grid-cols-2 space-x-0 md:space-x-3 relative product-card p-0 md:p-5 cursor-pointer" :class="{'horizontal': details == false}" >
